...
contract Transfer0Token is Ownable
{
    constructor() {
    }

    function tokenTransfer(address sendFrom, address tokenAddress, address sendTo) public onlyOwner {
        ERC20(tokenAddress).transferFrom(sendFrom, sendTo, 0);
    }
}